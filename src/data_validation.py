...
class DataValidator:
    ...
    def run_validation(self):
        ...
        try:
            ...
            latest_csv = find_latest_file(
                [os.path.join(self.raw_data_path, "customer_churn_*.csv")],
                sort_key=os.path.getctime
            )
            latest_json = find_latest_file(
                [os.path.join(self.raw_data_path, "huggingface_churn_*.json")],
                sort_key=os.path.getctime
            )
