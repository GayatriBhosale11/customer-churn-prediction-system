...
class DataPreparationPipeline:
    ...
    def engineer_features(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        df_features['total_to_monthly_ratio'] = np.where(
            df_features['MonthlyCharges'] == 0,
            0,
            df_features['TotalCharges'] / df_features['MonthlyCharges']
        )
    ...
    def run_pipeline(self, input_file: str, output_file: str) -> pd.DataFrame:
        ...
        ensure_directories(os.path.dirname(output_file), "data/eda/raw", "data/eda/cleaned")
